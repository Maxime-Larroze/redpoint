...
@section('public.mobile.application-android.view')
    <div class="col-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4 text-center">
        <img src="{{ asset('img/android-logo.png') }}" width="80%" class="img img-fluid" alt="Logo android">
    </div>
    <div class="col-8 col-md-8 col-lg-8 col-xl-8 col-xxl-8 d-flex flex-wrap align-items-center text-center">
    ...
    <div class="col-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 mt-5">
        <h2>Application Android - REDPOINT</h2>
        ...
        <div class="text-center">
            <a href=""><img src="{{ asset('img/download-android.png') }}" width="20%"
                    alt="logo de téléchargement android"></a>
        </div>
